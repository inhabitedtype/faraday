...
(* OASIS_START *)
(* DO NOT EDIT (digest: 1f769f1eb7cfb998bb4a55053eef3186) *)
(*
...
let setup_t =
  {
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$test_faraday", []))];
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/inhabitedtype/faraday";
          synopsis =
            ...
            [
               ...
               Library
                 ({
                   ...
                   },
                   {
                      ...
                      lib_findlib_name = Some "faraday";
                      lib_findlib_containers = []
                   });
               Library
                 ({
                     cs_name = "faraday_async";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {
                      lib_modules = ["Faraday_async"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "faraday";
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "test_faraday.ml"});
               Test
                 ({
                     cs_name = "test_faraday";
                     cs_data = PropList.Data.create ();
     ...
     oasis_version = "0.4.6";
     oasis_digest = Some "\006VP}\019\238\185k\243X\235\177\198\179\247\237";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
